...
<header class="main-header">
    ...
    <nav class="header-nav">
        <ul>
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdownCategories">
                    <?php if (!empty($categories)): ?>
                        <?php foreach ($categories as $cat): ?>
                            <li><a href="<?php echo $base_path; ?>user/search.php?cat_id=<?php echo htmlspecialchars($cat['category_id']); ?>">
            ...
            <li>
                <a href="<?php echo $base_path; ?>user/posts.php">Bài đăng</a>
            </li>
            <li>
                <a href="<?php echo $base_path; ?>user/find_posts.php">Bài tìm trọ</a>
            </li>

            <li class="dropdown-container">
                <a href="#" class="dropdown-toggle" id="navbarDropdownUser">
                    <?php if ($isLoggedIn): ?>
                        <img src="<?php echo $base_path; ?><?php echo htmlspecialchars($user['avatar']); ?>" 
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdownUser">
                    ...
                    <?php else: ?>
                        ...
                        <li><a href="<?php echo $base_path; ?>auth/register.php">➕ Đăng ký</a></li>
                    <?php endif; ?>
                </ul>
            </li>
        </ul>
